...
function Navbar() {
    ...
    useEffect(() => {
        ...
        let navlinks = document.getElementsByClassName('nav-link');     //nav-links 
            if (location.pathname == "/"){                              //when using hashrouter location.hash can be used
    ...
    return(
        <nav className="navbar fixed-top py-3 navbar-expand-lg" id="nav">    
            ...
            <div className="container-fluid px-md-5 px-3">
                <Link to="/" className="fw-normal navbar-brand ps-md-5"><span className="nav-brand">SCOSH - 2021</span></Link>
                ...
                <div className="collapse navbar-collapse flex-grow-0 panel-body" id="collapseNav">
                    <div className="navbar-nav">
                        <li className="nav-item">
                            <Link to="/blogs" className="nav-link text-end pe-4 pe-md-auto">Blogs</Link>
                        </li>
                        <li className="nav-item">
                            <Link to="/events" className="nav-link text-end pe-4 pe-md-auto">Events</Link>
                        </li>
                        <li className="nav-item">
                            <Link to="/workshops" className="nav-link text-end pe-4 pe-md-auto">Workshop</Link>
                        </li>
                        <li className="nav-item">
                            <Link to="/teamspage" className="nav-link text-end pe-4 pe-md-auto">Teams</Link>
                        </li>
                        <li className="nav-item">
                            <Link to="/contactpage" className="nav-link text-end pe-4 pe-md-auto">Contact</Link>
                        </li>
                    </div>
                </div>
            </div>
